...
func codigo() -> void:
	...
	print(peliculas.slice(1, 3)) #Indicando que se quiere obtener un array desde el indice 1 hasta el indice 3 (Excluyendolo).

	print("---Rango de Indices 2---")

	print(peliculas.slice(1)) #Indicando que se quiere obtener una lista desde el indice 1 hasta el último indice.
